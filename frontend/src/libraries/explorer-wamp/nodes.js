...
`SELECT agent_name as agentName, agent_version as agentVersion, agent_build as agentBuild, 
  ip_address as ipAddress, moniker, account_id as accountId, node_id as nodeId, 
  last_seen as lastSeen, last_height as lastHeight, peer_count as peerCount, is_validator as isValidator
    FROM nodes
    ORDER BY lastSeen DESC`;
