      ...
      {(context) => (
        <div className="vote">
            ...
            >
              <Row>
                ...
                <span style={{ color: "white", fontWeight: "400" }}>
                  <LargeBalance amount={context.totalStake} />
                </span>
              </Row>
              <Row>
            ...
            <Col md="4">
              <div className="vote-data">
                <span style={{ color: "#8DD4BD", fontWeight: "800" }}>
                  <LargeBalance amount={context.totalVotes} />
                </span>{" "}
                /{" "}
                <LargeBalance
                  amount={Big(context.totalStake)
          ...
          >
            ...
            <p>
              {Big(context.totalVotes)
                .div(Big(context.totalStake).times(Big(2)).div(Big(3)))
                .toFixed(2)}
              % / 100%
            </p>
          </Row>
